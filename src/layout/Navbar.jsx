  ...
  return (
    <>
      <div className=" w-full  m-auto bg-[#fafafa] h-full mb-4">
        <div className="container flex justify-between max-w-[1280px] m-auto p-4 ">
      ...
      <div className="w-full navlinks flex  m-auto max-w-[1280px] pb-6">
        <a href="#"><img src={qugo} /></a>
        
          <div className="nav-links-1">
            <a href="#" className="nav-link">Создать задание</a>
            <a href="#" className="nav-link">Найти задание</a>
            <a href="#" className="nav-link">Для бизнеса</a>
          </div>
          <div className="nav-links-2">
            <a href="#" className="nav-link">Сообщения</a>
            <a href="#" className="nav-link">Мои заказы 2</a>
